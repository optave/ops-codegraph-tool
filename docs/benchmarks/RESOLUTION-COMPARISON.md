...
100% precision on both languages. On JavaScript, codegraph leads on precision
(100% vs 94%); Jelly's recall (89% vs 83%) is higher because it resolves
receiver-typed calls through constructor-assigned properties, at the cost of
one false positive and two false negatives in other modes.

| Language | Tool | Precision | Recall | TP | FP | FN |
|----------|------|:---------:|:------:|---:|---:|---:|
| JavaScript | **Codegraph** | **100%** | 83% | 15 | 0 | 3 |
| JavaScript | Jelly 0.13.0 | 94% | 89% | 16 | 1 | 2 |
