...
27 GitHub issues total are attributable to this run's findings: **21 already filed during RECON/GAUNTLET/GRIND/PARITY** (#1720, #1721, #1723, #1724, #1725, #1726, #1727, #1728, #1729, #1730, #1731, #1741, #1760, #1761, #1769, #1770, #1771, #1772, #1773, #1776, #1778 — several are cross-referenced by multiple issue-tracker entries), and **6 newly filed at CLOSE** after a duplicate check against the open issue list:
